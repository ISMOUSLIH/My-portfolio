        ...
        <div className="container flex items-center justify-between">
            <a className="text-xl font-bold text-primary flex items-center" href="#Hero">
                <span className=" relative z-10 ">
                    <span className="text-glow text-foreground">Mouslih </span>
                    Ismail 
                </span>
            </a>
            ...
            {navItems.map((item,key)=>(
                <a key={key} href={item.href} className="capitalize text-foreground/80 hover:text-primary">
                    {item.name}
                </a>
            ))}
            ...
            {navItems.map((item,key)=>(
                <a key={key} href={item.href} className="capitalize text-foreground/80 hover:text-primary" onClick={()=>setIsMenuOpen(false)}>
                    {item.name}
                </a>
            ))}
            </div>
